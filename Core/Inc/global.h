...
enum TRAFFIC_STATE	{IDLE,
					...
					CHANGE_MODE, CHANGE_MODE_RED, CHANGE_MODE_YELLOW, CHANGE_MODE_GREEN,
					MODIFY_PRESSED, MODIFY_LONGPRESSED, SET_PRESSED,
					MANUAL_MODE, MANUAL_RED1_GREEN2, MANUAL_RED1_YELLOW2, MANUAL_GREEN1_RED2, MANUAL_YELLOW1_RED2,
